...
public class MenuViewModel extends ViewModel {
    ...
    private static final MutableLiveData<String> opinion = new MutableLiveData<>();

    //Declaramos el set del menu
    public void setMenuseleccionado(String menuVM){menuseleccionado.setValue(menuVM);}
    public void setOpinion(String opinion){opinion.setValue(opinion);}
    ...
    public LiveData<String> getOpinion(){ return opinion};
